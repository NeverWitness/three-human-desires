...
本仓库初始公开版本对应**三欲动力学模型 5.0 草稿版**。

## 文档

- **[01｜概述](docs/zh/预发布/01_概述.md)**  
  介绍三欲动力学模型整体在研究什么，以及基本的观察方式。

- **[02｜核心概念](docs/zh/预发布/02_核心概念.md)**  
  统一说明模型中的主要概念、术语和必要符号。

- **[03｜基础模型与三欲](docs/zh/预发布/03_基础模型与三欲.md)**  
  建立状态、欲望、行为、现实变化与感受之间的基础结构，并分别说明三欲。

- **[04｜动力变化与分析](docs/zh/预发布/04_动力变化与分析.md)**  
  说明欲望怎样发生基础变化、复合变化和长期变化，以及怎样分析这些过程。

- **[05｜解释能力](docs/zh/预发布/05_解释能力.md)**  
  展示模型可以怎样分析关系、修行和其他生活现象。

- **[06｜局限性](docs/zh/预发布/06_局限性.md)**  
  说明当前模型不能直接回答、尚未量化或仍存在识别困难的问题。

- **[07｜相关理论](docs/zh/预发布/07_相关理论.md)**  
